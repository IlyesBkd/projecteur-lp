    ...
    <article className="relative rounded-[32px] border border-zinc-200 bg-white p-6 shadow-[0_18px_40px_rgba(15,23,42,0.12)] md:p-10">
      ...
      <div className="pt-10">
        <div className="flex flex-col gap-2 text-center md:text-left">
          <h3 className="text-4xl font-bold uppercase tracking-tight text-zinc-900 md:text-5xl">
            {product.name}
          </h3>
        ...
        <div className="mt-8 space-y-6">
          {product.expertTitle ? (
            <h4 className="text-2xl font-bold text-zinc-900">{product.expertTitle}</h4>
          ) : null}
          <div className="grid gap-5 md:grid-cols-2">
            <div className="rounded-2xl bg-emerald-50 p-4">
              <p className="text-lg font-semibold uppercase text-emerald-700">Avantages</p>
              <ul className="mt-3 space-y-2 text-lg text-emerald-900">
            ...
            <div className="rounded-2xl bg-rose-50 p-4">
              <p className="text-lg font-semibold uppercase text-rose-600">Inconvénients</p>
              <ul className="mt-3 space-y-2 text-lg text-rose-900">
          ...
          {product.description ? (
            <p className="text-lg leading-relaxed text-zinc-700">{product.description}</p>
          ) : null}
          {product.editorialTip ? (
            <div className="bg-blue-50 p-3 rounded-md text-lg leading-relaxed text-zinc-700">
              {product.editorialTip}
            </div>
          ) : null}
        </div>
    ...
    <main className="min-h-screen bg-white text-zinc-900">
      <section className="mx-auto flex w-full max-w-5xl flex-col gap-6 px-4 pb-10 pt-8 sm:px-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xl font-semibold text-zinc-700 md:text-2xl">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
            ...
            <div className="space-y-1">
              <div className="flex items-center flex-wrap">
                <p className="text-2xl font-semibold">David Quentin</p>
                <span className="text-green-600 text-sm font-semibold bg-green-100 px-2 py-0.5 rounded-full ml-2">✓ Testeur Certifié</span>
              </div>
              ...
              <p className="text-2xl text-gray-500">Mis à jour le 26 Février 2026</p>
            </div>
          </div>
        </div>
        <a
          className="text-center text-2xl font-semibold text-blue-600"
          href="#classement"
        >
        ...
        />
        <div className="space-y-4 text-2xl leading-relaxed text-zinc-700">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div className="rounded-3xl border border-emerald-200 bg-emerald-50 p-5">
            <h3 className="text-3xl font-bold uppercase text-emerald-900">
              Que faut-il rechercher ?
            </h3>
            <ul className="mt-3 space-y-2 text-2xl text-emerald-900">
          ...
          <div className="rounded-3xl border border-rose-200 bg-rose-50 p-5">
            <h3 className="text-3xl font-bold uppercase text-rose-700">À éviter :</h3>
            <ul className="mt-3 space-y-2 text-2xl text-rose-900">
              {avoidList.map((item) => (
                <li key={item} className="leading-relaxed">
                  ❌ {item}
                </li>
        ...
        <a
          id="classement"
          className="rounded-full bg-blue-600 px-6 py-4 text-center text-2xl font-bold uppercase tracking-wider text-white shadow-lg shadow-blue-200"
          href="#classement"
        >
